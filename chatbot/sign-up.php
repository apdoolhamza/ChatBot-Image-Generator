...
if(!$row > 0) {
$qeury = mysqli_query($con,"INSERT INTO users(username,email,userpassword) VALUES('$username','$email','$encryptPassword')");
if($qeury) {
...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <title>ChatBot AI | User Sign Up</title>
...
<main class="form-signin w-100 m-auto">
  <form method="post" novalidate>
    ...
    <h1 class="h3 mb-3 fw-normal">User sign up</h1>

    <div class="form-floating">
      <input type="text" class="form-control" name="username" maxlength="20" id="username" oninput="removeSpace();" placeholder="apdoolhamza" required>
      <label for="username">Username</label>
    </div>
    <div class="form-floating">
      <input type="email" style="border-top-left-radius:0;border-top-right-radius: 0;" oninput="checkEmailAvailability();" class="form-control" name="email" id="email" placeholder="***@gmail.com" required>
    ...
    <button class="btn btn-primary w-100 py-2 rounded-1 my-3" type="submit" name="submit">Sign Up</button>
    <div class="pt-2" style="text-align:center;">
    <a href="user-sign.php" class="nav-link">Already sign up? <span style="color: #6e74e5;text-decoration:underline">Sign In</span></a>
    </div>
...
jQuery.ajax({
url: "ajex_validators/check-email-availability.php",
