...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <title>ChatBot AI | User Sign In</title>
...
<main class="form-signin w-100 m-auto">
  <form method="post" novalidate>
    ...
    <button class="btn btn-primary w-100 py-2 rounded-1" name="login" type="submit">Sign In</button>
    <div class="mt-3" style="text-align:center;">
    <a href="sign-up.php" class="nav-link">You don't have an account? <br> <span style="color: #6e74e5;text-decoration:underline">Sign Up</span></a>
    </div>
